"""Regression checks for the cinder-gfx-scene-flow casebook."""
...
from casebook.harness import assert_expected, cinder_gfx_scene_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cinder_gfx_scene_flow_summary(), assert_expected())
